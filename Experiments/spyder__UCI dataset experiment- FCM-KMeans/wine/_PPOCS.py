...
cluster=3
data=pd.read_csv('../../../dataset/wine.data', header=None, sep=',')  #
datasetname='iris'
...
data1=pd.read_csv('PPCOS_1_pred.txt');
data2=pd.read_csv('PPCOS_2_pred.txt');
data3=pd.read_csv('PPCOS_3_pred.txt');
data4=pd.read_csv('PPCOS_4_pred.txt');
data5=pd.read_csv('PPCOS_5_pred.txt');
